...
在下拉框中选择色彩模式和图像大小，点击“GENERATE”，实时获取由范围[0,255]的量子随机数合成的灰度、RGB 或 RGBA 图像。

等待时间与图像的分辨率和色彩深度成正比，256×256 灰度图像约 5 秒，1024×1024 灰度图像约 80 秒，RGB 和 RGBA 图像所需时间分别是同分辨率灰度图像的 3 倍和 4 倍，长时间不响应请重试。
